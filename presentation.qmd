...
- Chapter 3: Visualisation experiment
  ...
  - This is more of an "if I get to it" chapter as Chapter 1 and 2 are already quite long



# Chapter 1: <br> The Noisy Work of Uncertainty Visualisation

## A single example: choropleth map
- We are going to work through a single plot for this talk
- It makes the ideas we are talking about easier to understand
- Concepts are more broadly appliciable

## A strange example I invented for this talk
:::: {.columns}
...
## Issues with testing Signal Supression
